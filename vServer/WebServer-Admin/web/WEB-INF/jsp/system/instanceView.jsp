    ...
    <script type="text/javascript">
        ...
        jQuery(document).ready(function() {
            jQuery("#queryAccount").bind("click", function () {
                ...
                accounTable=jQuery('#instanceTable').dataTable( {
                    bPaginate:true,
                    bSort:false,
                    ...
                    "fnServerData": function ( sSource, aoData, fnCallback  ) {
                        ...
                        aoData.push( { "name": "id", "value": jQuery("select option:selected").val()  });
                        jQuery.ajax( {
                            "dataType": 'json',
                            "type": "get",
                            "url": sSource,
                            ...
                            "success": function(rep){
                                fnCallback(rep);
                                jQuery("#instanceTable_length").after( '<div class="dataTables_filter" id="example_filter"><label><a class="iconlink" href="system/instance/create">   <img src="resource/images/icons/small/white/plus.png" class="mgright5" alt=""><span>新增</span></a></label></div>');
                    ...
                    "aoColumns": [
                        ...
                        },
                        {
                            ...
                            "fnRender": function (obj) {
                                return    '<a class="iconlink2" href=\"system/instance/'+obj.aData.id+'/preview\"><img alt=\"查看\" src=\"resource/images/icons/small/black/search.png\"></a>' +
                                        '&nbsp;<a class="iconlink2" href=\"system/instance/'+obj.aData.id+'/update\"><img alt=\"编辑\" src=\"resource/images/icons/small/black/edit.png\"></a>'+
                                        '&nbsp;<a class="iconlink2" href=\"system/instance/'+obj.aData.id+'/deleteview\"><img alt=\"删除\" src=\"resource/images/icons/small/black/close.png\"></a>';
