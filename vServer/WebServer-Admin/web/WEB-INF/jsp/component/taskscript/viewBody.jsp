    ...
    <div class="left">
        ...
        <div class="dataTables_wrapper" id="pTable_wrapper">
            ...
            <div class="dataTables_filter" id="example_filter">
                <label>
                    <a class="iconlink" href="component/main/create?type=TASKSCRIPT" target="_blank">
            ...
            <table cellspacing="0" cellpadding="0" border="0" class="dyntable" id="pTable">
                ...
                <tr>
                    ...
                    <th colspan="1" rowspan="1" class="head0 sorting_disabled center" style="width: 30%;">说明</th>
                    <th colspan="1" rowspan="1" class="head1 sorting_disabled center" style="width: 20%;">操作</th>
                </tr>
                </thead>
                <colgroup>
                    <col class="con0">
