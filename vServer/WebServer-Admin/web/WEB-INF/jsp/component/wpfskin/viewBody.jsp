    ...
    <div class="left">
        ...
        <div class="dataTables_wrapper" id="pTable_wrapper">
            ...
            <div class="dataTables_filter" id="example_filter"><label>
                ...
                <a class="iconlink" href="component/main/create?type=WPFSKIN" target="_blank">
            ...
            <table cellspacing="0" cellpadding="0" border="0" class="dyntable" id="pTable">
                ...
                <tr>
                    ...
                    <th colspan="1" rowspan="1" class="head0 sorting_disabled center" style="width: 20%;">程序页面信息</th>
                ...
                <c:if test="${data.getTotalElements() > 0}">
                    <c:forEach items="${ data.getContent()}" varStatus="i" var="item">
                        <tr class="odd">
                            ...
                            <td style="vertical-align: text-top;">
                                <div class="tabledivWrapper">
                                    <div class="tabledivText">显示工具条：</div>
                                    <div class="tabledivValue">  <img  name="img" src="resource/images/icons/${item.showToolbar?'yes':'no'}.png" /> </div>
                                    <br clear="all">
                                    <div class="tabledivText">同步窗体大小：</div>
                                    <div class="tabledivValue"> <img  name="img" src="resource/images/icons/${item.showToolbar?'yes':'no'}.png" /></div>
                                    <br clear="all">
                                    <div class="tabledivText">打开方式：</div>
                                    <div class="tabledivValue">
                                        <c:choose>
                                            <c:when test="${ item.openMode==1}">
                                                弹出窗口
                                            </c:when>
                                            <c:when test="${ item.openMode==2}">
                                                合并窗口
                                            </c:when>
                                            <c:when test="${ item.openMode==3}">
                                                模式窗口
                                            </c:when>
                                            <c:otherwise>
                                                异常参数
                                    ...
                                    <br clear="all">
                                    <div class="tabledivText">显示位置：</div>
                                    <div class="tabledivValue">
                                        <c:choose>
                                            <c:when test="${ item.showLocation==1}">
                                                窗口居中
                                            </c:when>
                                            <c:when test="${ item.showLocation==2}">
                                                屏幕居中
                                            </c:when>
