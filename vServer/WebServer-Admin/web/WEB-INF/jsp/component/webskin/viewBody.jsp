    ...
    <div class="left">
        ...
        <div class="dataTables_wrapper" id="pTable_wrapper">
            ...
            <div class="dataTables_filter" id="example_filter">
                <label>
                    <a class="iconlink" href="component/main/create?type=WEBSKIN" target="_blank">
            ...
            <table cellspacing="0" cellpadding="0" border="0" class="dyntable" id="pTable">
                ...
                <c:forEach items="${ data.getContent()}" varStatus="i" var="item">
                    <tr class="odd">
                        ...
                        <td  style="vertical-align: text-top;">
                            <div class="tabledivWrapper">
                                <div class="tabledivText">网页类型：</div>
                                <div class="tabledivValue">
                                        ${item.contextType}
                                </div>
                                <br clear="all">
                                <div class="tabledivText">是否缓存：</div>
                                <div class="tabledivValue"> <img  name="img" src="resource/images/icons/${item.cache?'yes':'no'}.png" /></div>
                                <br clear="all">
                                <div class="tabledivText">缓存时间：</div>
                                <div class="tabledivValue">${item.cacheTime} （分钟）</div>
                                <br clear="all">
                                <div class="tabledivText">是否页面：</div>
                                <div class="tabledivValue"> <img  name="img" src="resource/images/icons/${item.page?'yes':'no'}.png" /></div>
                            </div>
                            <br clear="all">
                        </td>
