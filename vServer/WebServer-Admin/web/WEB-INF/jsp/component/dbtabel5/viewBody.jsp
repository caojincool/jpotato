        ...
        <div class="form_default">
            <fieldset>
                ...
                <jsp:include page="../common/queryCondition.jsp"/>
                    <tr>
                        <td class="firstColom">表类型:</td>
                        <td>
                            <select name="cate" tabindex="2" style="width: 150px;">
                                <c:forEach var="m" items="${m}">
                                    <option ${query.cate==m.key?'selected=\"selected\"':''}  value="${m.key}">${m.value}</option>
                                </c:forEach>
                            </select>
                        </td>
                    </tr>
                        ...
                        <tr class="odd">
                            ...
                            <td style="vertical-align: text-top; ">
                                <div class="tabledivWrapper">
                                    <jsp:include page="../common/td.jsp" >
                                        <jsp:param name="pid" value="${item.pid}"></jsp:param>
                                        <jsp:param name="createUser" value="${item.createUser}"></jsp:param>
                            ...
                            <td  style="vertical-align: text-top;">
                                <div class="tabledivWrapper">
                                    ...
                                    <div class="tabledivText">表名称：</div>
                                    <div class="tabledivValue"> ${item.dbtable}</div>
                                    <br clear="all">
                                    <div class="tabledivText">编码：</div>
                                    <div class="tabledivValue"> ${item.code}</div>
                                    <br clear="all">
                                    <c:set var="tableCategory" value="${item.cate}" scope="request"></c:set>
