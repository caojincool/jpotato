...
<div class="detailscontent">
        <h1 class="pageTitle">5代表组件删除确认</h1>
                ...
                <table width="100%" cellspacing="0" cellpadding="0" class="invoicetable">
                    ...
                    <c:forEach items="${resource.columns}" varStatus="i" var="column">
                        <tr>
                            ...
                            <td align="left">
                                <c:set var="cate" value="${column.category}" scope="request"/>
        ...
        <div class="bottombtn">
            <span><a class="iconlink" href="component/${type!=null?'main':fn:toLowerCase(resource.category)}/view?page=1&limit=20">返回</a>　&nbsp;<a class="iconlink" href="javascript:del();">删除</a></span>
        </div>
    <br clear="all">
</div>