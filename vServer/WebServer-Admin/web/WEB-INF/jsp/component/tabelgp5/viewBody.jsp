    ...
    <div class="left">
        <div class="form_default">
            <fieldset>
                ...
                <table width="100%">
                    ...
                    <td class="firstColom">表格类型:</td>
                    <td>
                    <select id="tableCategory" name="tableCategory" class="sf" style="height:28px;width: 140px;" >
                        <option value="-1" selected="selected">全部</option>
                        <c:forEach var="cate" items="<%=WebConstant.tableCategoryMap%>">
                            <option value="${cate.key}" ${cate.key==query.tableCategory?'selected=\"selected\"':''}>${cate.value}</option>
                        </c:forEach>
                    </select>
                    </td>
                </table>
        ...
        <div class="dataTables_wrapper" id="pTable_wrapper">
            ...
            <div class="dataTables_filter" id="example_filter">
                <label>
                <a class="iconlink" href="component/main/create?type=TABELGP5" target="_blank">
            ...
            <table cellspacing="0" cellpadding="0" border="0" class="dyntable" id="pTable">
                ...
                <tr>
                    ...
                    <th colspan="1" rowspan="1" class="head0 sorting_disabled center" style="width: 20%;">5代表信息</th>
                ...
                <tr>
                    <th colspan="1" rowspan="1" class="head0 sorting_disabled center" style="width: 8%;">预览图片</th>
                    <th colspan="1" rowspan="1" class="head1 sorting_disabled center" style="width: 22%;">组件基本信息</th>
                    <th colspan="1" rowspan="1" class="head0 sorting_disabled center" style="width: 20%;">5代表组信息</th>
                    <th colspan="1" rowspan="1" class="head1 sorting_disabled center" style="width: 30%;">说明</th>
                    <th colspan="1" rowspan="1" class="head0 sorting_disabled center" style="width: 20%;">操作</th>
                </tr>
                </tfoot>
                ...
                <c:if test="${data.totalElements > 0}">
                    ...
                    <tr class="odd">
                        ...
                        <td  style="vertical-align: text-top;">
                            <div class="tabledivWrapper">
                                <div class="tabledivText">编码：</div>
                                <div class="tabledivValue">
                                        ${item.code}
                                </div>
                                <br clear="all">
                                <div class="tabledivText">表格类型：</div>
                                <c:set var="tableCategory" value="${item.tableCategory}" scope="request"/>
                                <div class="tabledivValue"><%=WebConstant.tableCategoryMap.get((Integer) request.getAttribute("tableCategory"))%></div>
                            </div>
                            <br clear="all">
