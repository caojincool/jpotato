    ...
    <div class="left">
        ...
        <div class="dataTables_wrapper" id="pTable_wrapper">
            ...
            <div class="dataTables_filter" id="example_filter">
                <label>
                    <a class="iconlink" href="component/main/create?type=RESOURCE" target="_blank">
            ...
            <table cellspacing="0" cellpadding="0" border="0" class="dyntable" id="pTable">
                ...
                <tr>
                    ...
                    <th colspan="1" rowspan="1" class="head1 sorting_disabled center" style="width: 20%;">资源信息</th>
                        ...
                        <tr class="odd">
                            ...
                            <td  style="vertical-align: text-top;">
                                <div class="tabledivWrapper">
                                    ...
                                    <div class="tabledivText">文件名称：</div>
                                    <div class="tabledivValue"> ${item.fileName}</div>
                                    <br clear="all">
                                    <div class="tabledivText">文件大小：</div>
                                    <div class="tabledivValue"> ${item.fileSize}字节</div>
