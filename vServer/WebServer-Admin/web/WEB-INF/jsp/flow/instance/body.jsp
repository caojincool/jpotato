    ...
    <div class="left">
        <div class="form_default">
            <fieldset>
                ...
                <table width="100%">
                    <tr>
                        <td class="firstColom">流程名称:</td>
                        <td><input class="-required" type="text" id="name1" name="name"
                                   tabindex="1"/>
                        </td>
                        <td class="firstColom">发起人:</td>
                        <td><input class="-required" type="text" id="name2" name="name"
                                   tabindex="1"/>
                        </td>
                    ...
                    <tr>
                        <td class="firstColom">发起日期:</td>
                        <td><input class="-required" type="text" id="name3" name="name"
                                   tabindex="1"/>
                        </td>
                        <td class="firstColom">状态:</td>
                        <td><select id="state" name="state" tabindex="2" style="width: 150px;">
                            <option value="0" selected="selected">全部</option>
                            <option value="2">正在进行中的流程</option>
                            <option value="2">已走完的流程</option>
                        </select>
                        </td>
        ...
        <div id="accounTable_wrapper" class="dataTables_wrapper">
            <div id="accounTable_length" class="dataTables_length"><label>每页显示 <select name="accounTable_length"
                                                                                       size="1">
                <option value="10" selected="selected">10</option>
                <option value="25">25</option>
                <option value="50">50</option>
                <option value="100">100</option>
            </select> 项记录</label></div>
            <div class="dataTables_wrapper" id="example_wrapper">
                <table id="accounTable" class="dyntable" cellspacing="0" cellpadding="0" border="0">
                    ...
                    <tr>
                        ...
                        <th class="head1 " rowspan="1" colspan="1">流程名称</th>
                        <th class="head0 " rowspan="1" colspan="1">发起日期</th>
                        <th class="head0 " rowspan="1" colspan="1">发起人</th>
                    ...
                    <tr class="odd">
                        ...
                        <td class="center">请假</td>
                        <td class="center">2013年3月2日</td>
                        <td class="center">张三</td>
                        <td class="center">已完成</td>
                        <td class="center">
                            <a href="account/accountInfo?accountId=A00000150" class="iconlink2"><img
                                    src="resource/images/icons/small/black/user.png" alt="查看"></a>
                        </td>
                    </tr>
                    <tr class="even">
                        <td class="center">A00000150</td>
