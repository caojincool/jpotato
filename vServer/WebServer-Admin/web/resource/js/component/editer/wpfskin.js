...
Ext.onReady(function () {
        ...
        items: [
            {
                ...
                items: [
                    ...
                    },
                    {
                        ...
                        checked: lr.synchronismWindowSize,
                        inputValue: true
                    },
                    {
                        fieldLabel: '打开方式',
        ...
        items: [
            {
                ...
                listeners: {
                    afterrender: function (t) {
                        ...
                        Ext.Ajax.request({
                            url: rootPath + 'component/wpfskin/'+lr.pid+'/context',
                            method: 'get',
                            success: function (r) {
                                var temp = Ext.decode(r.responseText);
                                if(temp.entity!= undefined){
                                    editor.setValue(temp.entity);
                                }
    ...
    function executeSave(callback){
        ...
        startParamsStore.each(function (record) {
            var wpfParmsModel = {name: record.get('name'), cate: record.get('cate'), value: record.get('value'), remark: record.get('remark')};
        ...
        Ext.Ajax.request({
            url: rootPath + 'component/wpfskin/edit',
            jsonData: parms,
...
//            params:{
//                startParams:starParms
//            },
//            success: function(form, action) {
//                var result=Ext.decode(action.response.responseText);
//                var lmsResourse=Ext.decode(result.entity);
//                if(result.success){
//                    location.href=rootPath+'component/main/permission/'+lmsResourse.pid+'/'+lmsResourse.category;
//                }else{
//                    location.href=rootPath+'component/main/create';
//                }
//            },
