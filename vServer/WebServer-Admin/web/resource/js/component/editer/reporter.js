...
Ext.onReady(function () {
        ...
        items: [
            {
                ...
                items: [
                    ...
                    },
                    {
                        fieldLabel: '原文件',
                        xtype: 'displayfield',
                        value: '<a href=\"'+rootPath+'component/reporter/getReporterfile?pid='+lr.pid+'\">'+lr.prefix+'.'+lr.suffix+'</a>'
                    },
                    {
                        fieldLabel: '修改',
                        xtype: 'filefield',
    ...
    function executeSave(callback){
        ...
        if(form.isValid()){
            form.submit({
                method:'post',
                params:{data:Ext.JSON.encode(param)},
                url: rootPath + 'component/reporter/'+lr.pid+'/edit',
