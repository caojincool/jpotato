...
function switchView(id){
    ...
    if(id==1){
        jQuery("#list"+id).show();
        jQuery("#list"+(id+1)).hide();
        jQuery(".submenu li:first-child").addClass("current");
        jQuery(".submenu li:last-child").removeClass("current");
    }else{
        jQuery("#list"+id).show();
        jQuery("#list"+(id-1)).hide();
        jQuery(".submenu li:last-child").addClass("current");
        jQuery(".submenu li:first-child").removeClass("current");
    }
