...
<%--<script type=text/javascript src="/resource/js/system/categoryList.js"></script>--%>
<%--</head>--%>
...
<div class="defaultbody">
    <div class="header">
        ...
        <div class="tabmenu">
            <ul>
                <li class="current"><a class="dashboard" href="system/category/web"><span>网页系统</span></a></li>
                <li><a class="elements" href="system/category/wpf"><span>WPF 系统</span></a></li>
            </ul>
        </div><!-- tabmenu -->
            ...
            <fieldset style="padding: 10px;">
                ...
                <%--<dl style="margin: 20px;">--%>
                    <div>
                        <table style="width: 100% ;height:80px">
                            ...
                            <tr>
                                ...
                                <td>Key :</td>
                                <td style="color: red;" >
                                    <input id="ckey" name="ckey" rows="3" cols="138"
                                           class="inputNessCss" value="${listone.getKey()}" /> *</td>
                            </tr>
                        </table>

                        <p style="color:#000000;">起始页挂载资源 :</p>
                    ...
                    <div>
                        ...
                        <p style="float:left;visibility: hidden">*</p>
                        <textarea id="cparam" name="cparam" rows="8" cols="158" style="margin-left: 10px"
                                  class="cssinput">${listone.getParamstring()}</textarea>
                    </div>
                <%--</dl>--%>

                    <input type="submit" value="修改" id="ReturnButton" class="SubmitButton" />
