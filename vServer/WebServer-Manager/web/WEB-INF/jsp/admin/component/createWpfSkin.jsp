...
<head>
    ...
    <script type="text/javascript">
        ...
        {
            Ext.Ajax.request({
                url :"component/componentmain/wpfskin/update",
                params : {
                    pid:'${resource.pid}',
...
<div class="defaultbody">
    <div class="header">
        <jsp:include page="../_adminTitle.jsp?titlename=修改WPF界面"/>
    </div>
        ...
        <div id="navigation">
            ...
            <div>
                <table class="selftable">
                    ...
                    <tr>
                        <td>wpf皮肤:</td>
                        <td><textarea rows="5" cols="50" id="context"></textarea></td>
                    </tr>
                </table></div>
            <div>
