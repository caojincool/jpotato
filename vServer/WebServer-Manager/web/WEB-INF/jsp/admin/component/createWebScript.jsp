...
<head>
    ...
    <script type="text/javascript">
        ...
        {
            Ext.Ajax.request({
                url :"component/componentmain/webscript/update",
                params : {
                    pid:'${resource.pid}',
...
<div class="defaultbody">
    <div class="header">
        <jsp:include page="../_adminTitle.jsp?titlename=修改WEB脚本"/>
    </div>
            ...
            <div>
                <table class="selftable">
                    <tr>
                        ...
                        <td style="margin-left: 5">${resource.name}</td>
                    </tr>
                    <tr>
                        <td>说明:</td>
                        <td><input id="remark" type="text" value="${resource.remark}" style="margin-left: 5"/></td>
                    </tr>
                    <tr>
                        <td>webscript:</td>
                        <td><textarea id="context" rows="5" cols="40" style="margin-left: 5">${resource.context}</textarea></td>
                    </tr>
                </table></div>
            <div>
