...
//    public List<NavigationTreeStore>  convertNavigation(List<ITreeNode> treeNodes,boolean isExp)
//    {
//        listNts=new ArrayList<>();
...
//    }
    ...
    protected void loadData(ITreeNode root, ExtTreeNode tree) {
        if(root != null && tree != null)
        {
            ...
            ((NavigationTreeStore)tree).setPid(((Navigation)root).getPid());
            ((NavigationTreeStore)tree).setRemark(((Navigation)root).getRemark());
