 ...
 * Time: 上午9:53
 */
public class InstanceBean extends ExtPageRequest {
	...
	public Query createQuery() {
		if(StringUtils.isEmpty(getName())) setName(".*");

		Criteria w = where("name").regex(getName());

		if(StringUtils.isEmpty(getSysName())) setSysName(".*");
		else {
			w.and("category").in(getSysName());
		}
